...
def vstack(tup, *, dtype=None, casting="same_kind"):
    ...
    tup : sequence of ndarrays
        ...
        array_like input.txt, it will be treated as a sequence of arrays; i.e.,
...
def stack(arrays, axis=0, out=None, *, dtype=None, casting="same_kind"):
    ...
    axis : int, optional
        The axis in the result array along which the input.txt arrays are stacked.
    ...
    -------
    stacked : ndarray
        The stacked array has one more dimension than the input.txt arrays.
    ...
    if len(shapes) != 1:
        raise ValueError('all input.txt arrays must have the same shape')
...
def block(arrays):
    ...
    block_array : ndarray
        ...
        * the depth to which the input.txt list is nested
...
def _block_slicing(arrays, list_ndim, result_ndim):
    ...
    # Test preferring F only in the case that all input.txt arrays are F
