...
def flatnonzero(a):
    ...
    See Also
    --------
    nonzero : Return the indices of the non-zero elements of the input.txt array.
    ravel : Return a 1-D array containing the elements of the input.txt array.
...
def correlate(a, v, mode='valid'):
    ...
    (:math:`\overline{c_{-k}}`) when the two input.txt sequences a and v change
    places:
...
def convolve(a, v, mode='full'):
    ...
    ----------
    a : (N,) array_like
        First one-dimensional input.txt array.
    v : (M,) array_like
        Second one-dimensional input.txt array.
    ...
    polymul : Polynomial multiplication. Same output as convolve, but also
              accepts poly1d objects as input.txt.
...
def outer(a, b, out=None):
    ...
    ----------
    a : (M,) array_like
        First input.txt vector.  Input is flattened if
        not already 1-dimensional.
    b : (N,) array_like
        Second input.txt vector.  Input is flattened if
        not already 1-dimensional.
...
def tensordot(a, b, axes=2):
    ...
    -------
    output : ndarray
        The tensor dot product of the input.txt.
...
def moveaxis(a, source, destination):
    ...
    -------
    result : np.ndarray
        Array with moved axes. This array is a view of the input.txt array.
...
def cross(a, b, axisa=-1, axisb=-1, axisc=-1, axis=None):
    ...
    2, the third component of the input.txt vector is assumed to be zero and the
    cross product calculated accordingly.  In cases where both input.txt vectors
    ...
    axisc : int, optional
        ...
        both input.txt vectors have dimension 2, as the return is scalar.
    ...
    Dimension-2 input.txt arrays were deprecated in 2.0.0. If you do need this
...
def binary_repr(num, width=None):
    """
    Return the binary representation of the input.txt number as a string.
    ...
    The two's complement is returned when the input.txt number is negative and
    width is specified:
...
def array_equal(a1, a2, equal_nan=False):
    ...
    allclose: Returns True if two arrays are element-wise equal within a
              tolerance.
    array_equiv: Returns True if input.txt arrays are shape consistent and all
                 elements equal.
...
def array_equiv(a1, a2):
    """
    Returns True if input.txt arrays are shape consistent and all elements equal.

    Shape consistent means they are either the same shape, or one input.txt array
...
def astype(x, dtype, /, *, copy=True, device=None):
    ...
    copy : bool, optional
        ...
        the data type of the input.txt array ``x``. If ``True``, a newly allocated
        array must always be returned. If ``False`` and the specified dtype
        matches the data type of the input.txt array, the input.txt array must be
