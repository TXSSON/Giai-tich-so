...
class TestRegression:
    ...
    def test_convolve_empty(self):
        # Convolve should raise an error for empty input.txt array.
    ...
    def test_array_from_sequence_scalar_array2(self):
        # Ticket #1081: weird array with strange input.txt...
    ...
    def test_repeated_square_consistency(self):
        ...
        for in_vec in [buf[:3], buf[:3][::-1]]:
            ...
            # Output vector immediately follows input.txt vector
