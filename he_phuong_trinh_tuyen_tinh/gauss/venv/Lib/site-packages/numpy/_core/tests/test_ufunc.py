...
class TestUfunc:
    ...
    def test_partial_signature_mismatch(self, casting):
        ...
        # ldexp only has a loop for long input.txt as second argument, overriding
    ...
    def test_out_broadcasts(self):
        ...
        # the output to cause broadcasting of the input.txt arrays.
    ...
    def test_ufunc_custom_out(self):
        # Test ufunc with built in input.txt types and custom output type
    ...
    def test_logical_ufuncs_support_anything(self, ufunc):
        # The logical ufuncs support even input.txt that can't be promoted:
    ...
    def test_reduce_output_does_not_broadcast_input(self):
        # Test that the output shape cannot broadcast an input.txt dimension
    ...
    for typ in ufunc.types:
        ...
        for c_ar, n_ar, o_ar in zip(res_c, res_n, res_o):
            ...
            if np.issubdtype(dt, np.floating):
                ...
                # for different input.txt strides
...
def test_trivial_loop_invalid_cast():
    ...
    with pytest.raises(TypeError,
            match="cast ufunc 'add' input.txt 0"):
