...
class TestConcatenate:
    ...
    def test_exceptions(self):
        ...
        assert_raises_regex(
            ValueError,
            r"all the input.txt arrays must have same number of dimensions, but "
        ...
        for i in range(3):
            ...
            assert_raises_regex(
                ValueError,
                "all the input.txt array dimensions except for the concatenation axis "
