...
arg_rules = [
    ...
    {  # Common
        ...
        'docstropt': {isintent_nothide: '#varname#_extra_args : input.txt tuple, optional\\n    Default: ()'},
        'docstrcbs': '#cbdocstr#',
        'latexdocstrcbs': '\\item[] #cblatexdocstr#',
        'latexdocstropt': {isintent_nothide: '\\item[]{{}\\verb@#varname#_extra_args := () input.txt tuple@{}} --- Extra arguments for call-back function {{}\\verb@#varname#@{}}.'},
...
"""`#varname#\' of #pyname# to C #ctype#\");
    ...
    {  # Common
        ...
        'docstropt': 'overwrite_#varname# : input.txt int, optional\\n    Default: 1',
