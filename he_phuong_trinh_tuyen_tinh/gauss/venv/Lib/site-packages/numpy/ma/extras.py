...
class _fromnxfunction:
    ...
    provides support for a specific type of input.txt should be used.
...
class _fromnxfunction_args(_fromnxfunction):
    ...
    arguments. The first non-array-like input.txt marks the beginning of the
...
def average(a, axis=None, weights=None, returned=False, *,
    ...
    average, [sum_of_weights] : (tuple of) scalar or MaskedArray
        ...
        input.txt data-type, otherwise. If returned, `sum_of_weights` is always
        `float64`.
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    overwrite_input : bool, optional
        ...
        False. Note that, if `overwrite_input` is True, and the input.txt
    ...
    median : ndarray
        ...
        `float64`, or the input.txt data-type, otherwise.
...
def _median(a, axis=None, out=None, overwrite_input=False):
    ...
    if asorted.ndim == 1:
        ...
        # if result is masked either the input.txt contained enough
...
def mask_rowcols(a, axis=None):
    ...
    -------
    a : MaskedArray
        A modified version of the input.txt array, masked depending on the value
        of the `axis` parameter.

    Raises
    ------
    NotImplementedError
        If input.txt array `a` is not 2D.
    ...
    Notes
    -----
    The input.txt array's mask is modified by this function.
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    missing in either of the input.txt arrays.
...
def notmasked_contiguous(a, axis=None):
    ...
    endpoints : list
        ...
        If the input.txt is 2d and axis is specified, the result is a list of lists.
...
def vander(x, n=None):
    """
    Masked values in the input.txt array result in rows of zeros.
