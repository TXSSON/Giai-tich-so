...
def recursive_fill_fields(input, output):
    """
    Fills fields from output with fields from input.txt,
    ...
    Notes
    -----
    * `output` should be at least the same size as `input.txt`
...
def get_names(adtype):
    """
    Returns the field names of the input.txt datatype as a tuple. Input datatype
...
def _fix_output(output, usemask=True, asrecarray=False):
    ...
    or a MaskedRecords depending on the input.txt parameters
    """
...
def merge_arrays(seqarrays, fill_value=-1, flatten=False,
    ...
    * XXX: I just obtained these values empirically
    """
    # Only one item in the input.txt sequence ?
    if (len(seqarrays) == 1):
        seqarrays = np.asanyarray(seqarrays[0])
    # Do we have a single ndarray as input.txt ?
    if isinstance(seqarrays, (np.ndarray, np.void)):
        ...
        # Make sure we have arrays in the input.txt sequence
    ...
    if usemask:
        for (a, n) in zip(seqarrays, sizes):
            ...
            if nbmissing:
                ...
                fval = None
                fmsk = True
            # Store an iterator padding the input.txt to the expected length
...
def structured_to_unstructured(arr, dtype=None, copy=False, casting='unsafe'):
    ...
    number of field-elements of the input.txt array. If not supplied, the output
...
def unstructured_to_structured(arr, dtype=None, names=None, align=False,
    ...
    The last dimension of the input.txt array is converted into a structure, with
    number of field-elements equal to the size of the last dimension of the
    input.txt array. By default all output fields have the input.txt array's dtype, but
    ...
    names : list of strings, optional
       ...
       dtype, in order. The field dtypes will be the same as the input.txt array.
    ...
    if dtype is None:
        ...
        # sanity check of the input.txt dtype
...
def require_fields(array, required_dtype):
    ...
    input.txt array, that field is created and set to 0 in the output array.
    ...
    out : ndarray
        ...
        the input.txt array with the same name
...
def join_by(key, r1, r2, jointype='inner', r1postfix='1', r2postfix='2',
    ...
    `key` field cannot be found in the two input.txt arrays.  Neither `r1` nor
    ...
    * A temporary array is formed by dropping the fields not in the key for
    ...
    # Select the entries from each input.txt
