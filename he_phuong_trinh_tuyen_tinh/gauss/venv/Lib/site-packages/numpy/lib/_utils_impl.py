...
def safe_eval(source):
    ...
    .. warning::
        ...
        to evaluate large input.txt strings.
...
def _median_nancheck(data, result, axis):
    ...
    ----------
    data : array
        Sorted input.txt data to median function
    ...
    result : scalar or ndarray
        Median or NaN in axes which contained NaN in the input.txt.  If the input.txt
        was an array, NaN will be inserted in-place.  If a scalar, either the
        input.txt itself or a scalar NaN.
    """
    if data.size == 0:
        return result
