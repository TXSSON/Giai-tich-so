...
class TestSetOps:
    ...
    def test_isin_boolean(self, kind):
        """Test that isin works for boolean input.txt"""
    ...
    def test_isin_timedelta(self, kind):
        """Test that isin works for timedelta input.txt"""
    ...
    def test_isin_mixed_dtype(self, dtype1, dtype2, kind):
        """Test that isin works as expected for mixed dtype input.txt."""
    ...
    def test_isin_mixed_boolean(self, kind):
        """Test that isin works as expected for bool/int input.txt."""
