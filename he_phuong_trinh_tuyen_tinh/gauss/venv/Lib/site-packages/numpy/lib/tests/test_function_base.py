...
class TestAverage:
    ...
    def test_weights(self):
        ...
        # weights and input.txt have different shapes but no axis is specified
        with pytest.raises(
                TypeError,
...
class TestGradient:
    ...
    def test_masked(self):
        ...
        # And make sure that the output and input.txt don't have aliased mask
        # arrays
...
class TestQuantile:
    ...
    def test_fraction(self):
        # fractional input.txt, integral quantile
        x = [Fraction(i, 2) for i in range(8)]
        q = np.quantile(x, 0)
        assert_equal(q, 0)
        ...
        # repeat with integral input.txt but fractional quantile
        x = np.arange(8)
...
class TestSortComplex:
    ...
    def test_sort_real(self, type_in, type_out):
        # sort_complex() type casting for real input.txt types
    ...
    def test_sort_complex(self):
        # sort_complex() handling of complex input.txt
