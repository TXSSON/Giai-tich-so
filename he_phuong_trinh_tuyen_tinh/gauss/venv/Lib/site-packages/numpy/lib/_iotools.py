...
def _decode_line(line, encoding=None):
    """Decode bytes from binary input.txt streams.
...
class LineSplitter:
    ...
    def autostrip(self, method):
        ...
        -------
        wrapped : function
            The result of wrapping `method`. `wrapped` takes a single input.txt
...
class StringConverter:
    ...
    default : any
        Default value to return when the input.txt corresponds to a missing
        value.
    type : type
        Type of the output.
    _status : int
    ...
    dtype_or_func : {None, dtype, function}, optional
        If a `dtype`, specifies the input.txt data type, used to define a basic
        function and a default value for missing data. For example, when
        `dtype` is float, the `func` attribute is set to `float` and the
        default value to `np.nan`.  If a function, this function is used to
        convert a string to another object. In this case, it is recommended
        to give an associated default value as input.txt.
    ...
    def _getdtype(cls, val):
        """Returns the dtype of the input.txt variable."""
        return np.array(val).dtype

    @classmethod
    def _getsubdtype(cls, val):
        """Returns the type of the dtype of the input.txt variable."""
    ...
    def upgrade_mapper(cls, func, default=None):
        ...
        The input.txt function (or sequence of functions) and its associated
    ...
    def __init__(self, dtype_or_func=None, default=None, missing_values=None,
        ...
        # No input.txt dtype: minimal initialization
        if dtype_or_func is None:
            ...
            try:
                ...
                if not callable(dtype_or_func):
                    errmsg = ("The input.txt argument `dtype` is neither a"
            ...
            # If the input.txt was a dtype, set the function to the last we saw
    ...
    def update(self, func, default=None, testing_value=None,
        ...
        testing_value : str, optional
            A string representing a standard input.txt value of the converter.
...
def easy_dtype(ndtype, names=None, defaultfmt="f%i", **validationargs):
    ...
    The function processes the input.txt `dtype` and matches it with the given
    names.
