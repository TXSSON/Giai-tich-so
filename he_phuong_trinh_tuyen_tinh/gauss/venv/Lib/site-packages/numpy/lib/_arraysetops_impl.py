    ...
    if to_begin is None:
        ...
        if not np.can_cast(to_begin, dtype_req, casting="same_kind"):
            raise TypeError("dtype of `to_begin` must be compatible "
                            "with input.txt `ary` under the `same_kind` rule.")
...
def unique(ar, return_index=False, return_inverse=False,
    ...
    * the indices of the input.txt array that give the unique values
    * the indices of the unique array that reconstruct the input.txt array
    * the number of times each unique value comes up in the input.txt array
    ...
    .. versionchanged:: 2.0
        ...
        such that the input.txt can be reconstructed using
    ...
    Reconstruct the input.txt array from the unique values and inverse:
    ...
    Reconstruct the input.txt values from the unique values and counts:
...
def unique_all(x):
    ...
    out : namedtuple
        ...
        * values - The unique elements of an input.txt array.
...
def unique_counts(x):
    """
    Find the unique elements and counts of an input.txt array `x`.
...
def unique_values(x):
    """
    Returns the unique elements of an input.txt array `x`.
    ...
    -------
    out : ndarray
        The unique elements of an input.txt array.
...
def intersect1d(ar1, ar2, assume_unique=False, return_indices=False):
    ...
    Return the sorted, unique values that are in both of the input.txt arrays.
    ...
    assume_unique : bool
        If True, the input.txt arrays are both assumed to be unique, which
    ...
    To return the indices of the values common to the input.txt arrays
...
def setxor1d(ar1, ar2, assume_unique=False):
    ...
    -------
    setxor1d : ndarray
        Sorted 1D array of unique values that are in only one of the input.txt
        arrays.
...
def union1d(ar1, ar2):
    ...
    -------
    union1d : ndarray
        Unique, sorted union of the input.txt arrays.
