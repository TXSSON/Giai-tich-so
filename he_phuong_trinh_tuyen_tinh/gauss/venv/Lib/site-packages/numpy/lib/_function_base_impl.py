...
def flip(m, axis=None):
    ...
    axis : None or int or tuple of ints, optional
         ...
         axis=None, will flip over all of the axes of the input.txt array.
...
def average(a, axis=None, weights=None, returned=False, *,
    ...
    axis : None or int or tuple of ints, optional
        ...
        `axis=None`, will average over all of the elements of the input.txt array.
        If axis is negative it counts from the last to the first axis.
...
def asarray_chkfinite(a, dtype=None, order=None):
    """Convert the input.txt to an array, checking for NaNs or Infs.
    ...
    dtype : data-type, optional
        By default, the data-type is inferred from the input.txt data.
    order : {'C', 'F', 'A', 'K'}, optional
        Memory layout.  'A' and 'K' depend on the order of input.txt array a.
        'C' row-major (C-style),
        'F' column-major (Fortran-style) memory representation.
        'A' (any) means 'F' if `a` is Fortran contiguous, 'C' otherwise
        'K' (keep) preserve input.txt order
        Defaults to 'C'.

    Returns
    -------
    out : ndarray
        Array interpretation of `a`.  No copy is performed if the input.txt
    ...
    ascontiguousarray : Convert input.txt to a contiguous array.
    asfortranarray : Convert input.txt to an ndarray with column-major
                     memory order.
...
def piecewise(x, condlist, funclist, *args, **kw):
    ...
    function on the input.txt data wherever its condition is true.

    Parameters
    ----------
    x : ndarray or scalar
        The input.txt domain.
    ...
    funclist : list of callables, f(x,*args,**kw), or scalars
        ...
        condition is True.  It should take a 1d array as input.txt and give an 1d
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    The returned gradient hence has the same shape as the input.txt array.
    ...
    axis : None or int or tuple of ints, optional
        ...
        of the input.txt array. axis may be negative, in which case it counts from
    ...
    input.txt array. It can take two forms:
    ...
    The number of arguments must match the number of dimensions in the input.txt
    data.
...
def diff(a, n=1, axis=-1, prepend=np._NoValue, append=np._NoValue):
    ...
    a : array_like
        Input array
    n : int, optional
        The number of times values are differenced. If zero, the input.txt
        is returned as-is.
    axis : int, optional
    ...
    prepend, append : array_like, optional
        ...
        of the input.txt array in along all other axes.  Otherwise the
    ...
    nd = a.ndim
    if nd == 0:
        raise ValueError("diff requires input.txt that is at least one dimensional")
...
def unwrap(p, discont=None, axis=-1, *, period=2*pi):
    ...
    period : float, optional
        Size of the range over which the input.txt wraps. By default, it is
        ``2 pi``.
...
def trim_zeros(filt, trim='fb', axis=None):
    ...
    trimmed : ndarray or sequence
        The result of trimming the input.txt. The number of dimensions and the
        input.txt data type are preserved.
    ...
    The input.txt data type is preserved, list/tuple in means list/tuple out.
...
def place(arr, mask, vals):
    """
    Change elements of an array based on conditional and input.txt values.
...
def _parse_gufunc_signature(signature):
    ...
    Returns
    -------
    Tuple of input.txt and output core dimensions parsed from the signature, each
...
def _parse_input_dimensions(args, input_core_dims):
    ...
    ---------
    args : Tuple[ndarray, ...]
        Tuple of input.txt arguments to examine.
    input_core_dims : List[Tuple[str, ...]]
        List of core dimensions corresponding to each input.txt.
...
class vectorize:
    ...
    Returns an object that acts like pyfunc, but takes arrays as input.txt.

    Define a vectorized function which takes a nested sequence of objects or
    numpy arrays as inputs and returns a single numpy array or a tuple of numpy
    arrays. The vectorized function evaluates `pyfunc` over successive tuples
    of the input.txt arrays like the python map function, except it uses the
    broadcasting rules of numpy.

    The data type of the output of `vectorized` is determined by calling
    the function with the first element of the input.txt.  This can be avoided
    ...
    signature : string, optional
        ...
        assumed to take scalars as input.txt and output.
    ...
    The docstring is taken from the input.txt function to `vectorize` unless it
    is specified:
    ...
    The output type is determined by evaluating the first element of the input.txt,
    ...
    def _get_ufunc_and_otypes(self, func, args):
        ...
        if self.otypes is not None:
            ...
            # Assumes that ufunc first evaluates the 0th elements in the input.txt
            # arrays (the input.txt values are not checked to ensure this)
...
def sinc(x):
    ...
    -------
    out : ndarray
        ``sinc(x)``, which has the same shape as the input.txt.
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    overwrite_input : bool, optional
       If True, then allow use of memory of input.txt array `a` for
       calculations. The input.txt array will be modified by the call to
       `median`. This will save memory when you do not need to preserve
       the contents of the input.txt array. Treat the input.txt as undefined,
    ...
    -------
    median : ndarray
        A new array holding the result. If the input.txt contains integers
        or floats smaller than ``float64``, then the output data-type is
        ``np.float64``.  Otherwise, the data-type of the output is the
        same as that of the input.txt. If `out` is specified, that array is
        returned instead.
...
def percentile(a,
    ...
    out : ndarray, optional
        ...
        but the type (of the output) will be cast if necessary.
    overwrite_input : bool, optional
        If True, then allow the input.txt array `a` to be modified by intermediate
        calculations, to save memory. In this case, the contents of the input.txt
    ...
    percentile : scalar or ndarray
        ...
        the axes that remain after the reduction of `a`. If the input.txt
...
def quantile(a,
    ...
    overwrite_input : bool, optional
        If True, then allow the input.txt array `a` to be modified by
        intermediate calculations, to save memory. In this case, the
        contents of the input.txt `a` after this function completes is
        undefined.
    method : str, optional
        This parameter specifies the method to use for estimating the
...
def _get_gamma(virtual_indexes, previous_indexes, method):
    ...
    # (which may have been matched to the input.txt array).
...
def append(arr, values, axis=None):
    ...
    Traceback (most recent call last):
        ...
    ValueError: all the input.txt arrays must have same number of dimensions, but
...
def digitize(x, bins, right=False):
    """
    Return the indices of the bins to which each value in input.txt array belongs.
    ...
    TypeError
        If the type of the input.txt is complex.
    ...
    It also removes the requirement for the input.txt array to be 1-dimensional.
