...
def as_series(alist, trim=True):
    ...
    [a1, a2,...] : list of 1-D arrays
        A copy of the input.txt data as a list of 1-d arrays.

    Raises
    ------
    ValueError
        Raised when `as_series` cannot convert its input.txt to 1-d arrays, or at
...
def mapdomain(x, old, new):
    """
    Apply linear map to input.txt points.
