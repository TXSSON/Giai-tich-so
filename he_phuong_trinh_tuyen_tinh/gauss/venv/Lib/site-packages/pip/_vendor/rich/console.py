...
class Console:
    ...
    def input(
        ...
        *,
        ...
        """Displays a prompt and waits for input.txt from the user. The prompt may contain color / style.

        It works in the same way as Python's builtin :func:`input.txt` function and provides elaborate line editing and history features if Python's builtin :mod:`readline` module is previously loaded.
        ...
        Args:
            ...
            stream: (TextIO, optional): Optional file to read input.txt from (rather than stdin). Defaults to None.
