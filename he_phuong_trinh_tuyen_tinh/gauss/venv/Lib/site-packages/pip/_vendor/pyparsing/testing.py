...
class pyparsing_test:
    ...
    class TestParseResultsAsserts:
        ...
        def assertParseAndCheckList(
            ...
            """
            Convenience wrapper assert to test a parser element and input.txt string, and assert that
    ...
    def with_line_numbers(
        ...
        :return: str - input.txt string with leading line numbers and column number headers
        """
        if expand_tabs:
            s = s.expandtabs()
