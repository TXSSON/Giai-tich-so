...
def one_of(
    ...
    *,
    ...
    regardless of the input.txt order, but returns
    ...
    if useRegex:
        ...
        try:
            ...
            if caseless:
                ...
                # casing as found in input.txt string
...
def original_text_for(
    ...
    intervening whitespace back to the original matching input.txt text. By
    ...
    matched text from the input.txt string.  So if the expression passed to
