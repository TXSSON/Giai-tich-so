...
class ParseBaseException(Exception):
    ...
    def explain_exception(exc, depth=16):
        ...
        - depth (default=16) - number of levels back in the stack trace to list expression
          ...
          the failing input.txt line, marker, and exception string will be shown
    ...
    def mark_input_line(
        ...
        """
        Extracts the exception line from the input.txt string, and marks
...
class ParseException(ParseBaseException):
    """
    Exception thrown when a parse expression doesn't match the input.txt string
