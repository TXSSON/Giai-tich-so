    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'hex', 'id', 'input.txt', 'int', 'isinstance',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'input.txt', 'int', 'intern', 'isinstance', 'issubclass', 'iter', 'len',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'hex', 'id', 'input.txt', 'int', 'intern', 'isinstance',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'input.txt', 'isinstance', 'issubclass', 'iter', 'iterate', 'last', 'len',
